...
public class InfluxdbReporter extends ScheduledReporter {
    ...
    public static class Builder {
        ...
        /**
         * Builds a {@link InfluxdbReporter} with the given properties, sending metrics using the
         * given {@link Influxdb} client.
         *
    ...
    // Optimization : use pointsXxx to reduce object creation, by reuse as arg of Influxdb.appendSeries(...)
